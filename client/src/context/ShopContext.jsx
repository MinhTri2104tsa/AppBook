...
const ShopContextProvider = ({ children }) => {
  ...
  //fetch books from API or local data
...
const fetchAdmin = async ()=>{
  try {
    const {data} = await axios.post('/api/admin/is-auth')
...
const logoutUser = async ()=>{
  ...
  const value = { books, navigate, user, setUser, currency, searchQuery
    , setSearchQuery,cartItems, setCartItems, addToCart
    ,getCartAmount,getCartCount,updateQuantity, method, 
    setMethod, delivery_charges, showUserLogin, setShowUserLogin,
     isAdmin, setIsAdmin, axios, fetchBooks, fetchUser, logoutUser}
