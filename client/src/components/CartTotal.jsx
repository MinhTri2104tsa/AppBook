    ...
    <div>
      ...
      <div className="mb-5">
        ...
        <div className="my-6">
          ...
          <div className="flex gap-3">
            ...
            className={`${method === "COD" ? "btn-secondary" : "btn-white"} !py-1 text-xs cursor-pointer`}>Cash on Delivery</div>
            <div onClick={()=>setMethod("stripe")} 
            className={`${method === "stripe" ? "btn-secondary" : "btn-white"} !py-1 text-xs cursor-pointer`}>Stripe</div>
          </div>
        </div>
        <hr className="border-gray-300 my-5" />
      </div>
      <div className="mt-4 space-y-2">
        ...
        <div className="flex justify-between">
          ...
          <p className="font-bold">
            {currency}
            {getCartAmount() === 0 ? "0.00" : `${currency} ${delivery_charges}`}
          </p>
        </div>
        <div className="flex justify-between">
