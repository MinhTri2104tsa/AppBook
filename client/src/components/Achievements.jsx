  ...
  return (
    <section className='mx-auto max-w-[1440px]'>
      ...
      <div className='flex flex-col xl:flex-row gap-12'>
        {/* LEFT SIDE */}
        <div className='flex-[2] flex justify-center flex-col bg-gradient-to-l
        from-tertiary/40 to-white px-6 lg:px-12 py-16'>
          <h2 className='h2'>Our Journey So Far</h2>
          <p className='py-5 max-w-[47rem]'>We have achieved significant milestones in our journey, 
            thanks to our dedicated team and loyal customers.</p>
        ...
        {/* RIGHT SIDE */}
        <div className='flex-1 relative max-sm:pl-8 flex items-center
         xl:justify-center pt-5'>
          <div className='flex-col'>
            <Title title1={"About"} title2={"Us"} titleStyles={"pb-10"} paraStyles={"hidden"} />
