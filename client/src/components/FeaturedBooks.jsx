...
const FeaturedBooks = () => {
  ...
  return (
    <section className='max-padd-container max-sm:bg-primary '>
        {/* CONTAINER */}
        <div className='sm:px-10 sm:bg-primary py-16 rounded-2xl flex flex-col xl:flex-row gap-10'>
            {/* LEFT SIDE */}
            <div className='flex-1'>
                <Title title1={"Featured"} title2={"Books"} 
                titleStyles={"pb-8"} 
                ...
                <div className='flex gap-3 sm:gap-8 sm:bg-white sm:p-4 rounded-2xl'>
                    ...
                    <div className='min-w-[160px]'>
                        ...
                        className='h-64 w-44 object-cover rounded-xl shadow-[0px_0px_2px_0px_rgba(0,_0,_0,_0.1)]'
                        />
                    </div>
                    <div className='flex flex-col justify-between flex-1'>
                        ...
                        className="btn-secondary max-sm:text-xs mt-1 sm:mt-5 w-fit px-5 py-2 flex items-center gap-2 text-sm font-medium">
                            <TbShoppingBagPlus className='text-lg'/>Add to Cart</button>
                    </div>
                </div>
            </div>
            {/* RIGHT SIDE */}
