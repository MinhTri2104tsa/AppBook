  ...
  return (
    <section className='max-padd-container py-8 mt-2'>
      <div className='flexBetween flex-wrap gap-7'>
        <div>
            <h4 
            className="bold-14 uppercase tracking-wider">Subscribe newsletter</h4>
        ...
        <div>
            <div className='flex bg-primary'>
                ...
                />
                <button className='btn-secondary !rounded-none !text-[13px] !font-bold
                 uppercase'>Submit</button>
            </div>
        </div>
